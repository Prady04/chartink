...
bullrun = {"BullR":"( {57960} ( [0] 5 minute close > 1 day ago high and latest low > 1 day ago close and latest open > 1 day ago close and latest volume > latest sma ( latest volume , 20 ) * 1.2 and 1 day ago open > 1 day ago close and 1 day ago close > 1 day ago low * 0.95 and latest volume > 70000 and latest close > 50 and latest close < 900 ) )   "}
                
bullEng = {"BullE": "( {33489} ( [-1] 15 minute close > [-1] 15 minute open and [-2] 15 minute open > [-2] 15 minute close and [-1] 15 minute open < [-2] 15 minute close and [-1] 15 minute close > [-2] 15 minute open and latest volume > 50000 ) ) "} 

bearEng = {"BearE":"( {33489} ( [-1] 15 minute close < [-1] 15 minute open and [-2] 15 minute open < [-2] 15 minute close and [-1] 15 minute open > [-2] 15 minute close and [-1] 15 minute close < [-2] 15 minute open and latest volume > 50000 ) ) " }